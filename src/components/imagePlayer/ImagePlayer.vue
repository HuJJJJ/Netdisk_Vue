<template>
  <div class="ImagePlayer" v-if="isImgDialogShow">
    ...
    >
     ...
     <div class="control">
      <i class="iconfont el-icon-zoom-in" @click="changeSize('large')"></i>
      <i class="iconfont el-icon-zoom-out" @click="changeSize('small')"></i>
      <i class="iconfont el-icon-refresh-right" @click="rotateImg"></i>
      <i
