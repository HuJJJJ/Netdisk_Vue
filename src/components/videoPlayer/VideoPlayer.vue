<template>
  <div
    class="VideoPlayer"
    :class="isVideoPlayerShow ? 'showVideoPlayer' : 'closeVideoPlayer'"
  >
    <div class="close">
      <i class="iconfont icon-close" @click="closeVideoPlayer">X</i>
    </div>
...
export default {
  ...
  methods: {
    ...
    closeVideoPlayer() {
      ...
      this.$store.commit("setIsVideoPlayerShow", false);
      //   半秒后清空数据
      clearTimeout(timer);
      timer = setTimeout(() => {
        this.videoInfo = {
