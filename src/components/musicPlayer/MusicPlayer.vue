    ...
    <div class="top">
      <div class="cover">
        ...
        <div class="iconContainer" @click="changePlayState">
          <i class="iconfont el-icon-video-play" v-if="!playState"></i>
          <i class="iconfont el-icon-video-pause" v-else></i>
        </div>
      </div>
      <div class="musicInfo">
     ...
     <i class="iconfont el-icon-close" @click="closeMusicPlayer"></i>
    </div>
...
export default {
  ...
  methods: {
    ...
    closeMusicPlayer() {
      ...
      this.progress = 0;
      this.playState = false;
      this.$store.commit("setIsMusicPlayerShow", false);
      this.$store.commit("setCurrentMusicInfo", this.currentMusicInfo);
      this.audioUrl = "";
    },
    ...
    async getAudioUrl() {
      ...
      this.audioUrl = this.currentMusicInfo.url;
    },
  },
