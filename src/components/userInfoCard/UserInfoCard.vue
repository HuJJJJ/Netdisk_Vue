<template>
  <div class="UserInfoCard" v-if="userInfo">
    ...
    <div class="menuContainer">
      ...
      <i class="iconfont el-icon-s-tools" @click="showMenu"></i>
    </div>
    ...
    <el-dialog
      ...
      class="aboutDialog"
    >
         Copyright ©2022 hublog.club ALL Rights Reserved | 桂ICP备2022004642号
    </el-dialog>
  </div>
</template>
  ...
  methods: {
    ...
    showMenu() {
      setTimeout(() => {
        ...
        // this.$store.commit("setIsUserInfoCardMenuShow", true);
      });
    },
